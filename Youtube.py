...
def videodownloader():
    global downloaded, quality, qTag, link_descriptor, link_enter, download
...
def playlistdownloader():
    ...
    try:
        ...
        # --- Run ClearEntryField func
        ClearEntryField(title)
...
def ClearEntryField(title):
    global downloaded

    # --- Recreate the downloaded object with desired settings
...
def vid_to_playlist():
    ...
    global video_playlist, switch, link_descriptor, download
